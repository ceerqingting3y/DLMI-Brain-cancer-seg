...
from unet import UNet,TorchDataset,flip_scale_crop_test,flip_scale_crop_train,Hybrid_Unet
...
session_name = '3D_unet_middle_fusion_new_' +str(epochs)
...
if train:
    # train model
    model = Hybrid_Unet(4,4,[16,32,64,128,128],[256, 128, 64,64])
    model.to(device)
